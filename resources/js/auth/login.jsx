        ...
        >
            ...
            <div className="min-h-screen flex flex-col lg:flex-row">
                ...
                <div className="absolute inset-0">
                        <img src="/images/bg_rect.png" alt="Background" className="w-full h-full object-cover" />
            </div>
                ...
                <div className="relative z-10 text-center text-white">
                    ...
                    Perpustakaan DTC
                        ...
                        <p className="text-sm lg:text-base opacity-90">
                            Belum punya akun? <span className="underline cursor-pointer hover:opacity-80">Daftar</span>
                        </p>
                    </div>
            </div>
                ...
                <div className="relative lg:w-3/5 bg-[#E3CD98] flex items-center justify-center px-6 sm:px-8 py-12 lg:py-0 min-h-[50vh] lg:min-h-screen">
                    ...
                    <div className="w-full max-w-sm relative z-10">
                        {/* Login Title */}
                        <h2 className="text-2xl lg:text-3xl font-bold text-black text-center mb-6">
                    Masuk
                        </h2>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
                            ...
                            <input 
                                ...
                                required
                                    className="w-full px-3 py-2 sm:py-3 pr-10 bg-white rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#2D5A5A] focus:border-transparent text-gray-700 placeholder-gray-500 text-sm"
                                />
                        ...
                        type="submit" 
                            ...
                            <div className="text-center mt-6">
                                ...
                                <div className="flex justify-center space-x-2 sm:space-x-3">
                                    {/* Google Button */}
                                    <button type="button" className="w-8 h-8 sm:w-10 sm:h-10 bg-white rounded-lg border border-gray-300 flex items-center justify-center hover:shadow-md transition-shadow duration-200">
